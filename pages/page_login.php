            ...
            <div id="hesap_menu_overflow">
                <div id="hesap_menu">                   
                    <form method="post" class="s_form" id="loginForm" style="display:flex">
                        ...
                        <div class="inputBox"><input type="text" id="lnumber" name="number" maxlength="12" placeholder="" required> <i>Number</i> </div>
                        ...
                        <div class="label_btns">
                            ...
                            <label class="label_btn" onclick="TestAccountLogin();">Guest</label>
                        </div>                       
                    ...
                    <form method="post" class="s_form" id="signupForm" style="display:none">
                        ...
                        <div class="inputBox"><input type="text" id="cnumber" name="number" maxlength="12" placeholder="" required> <i>Number</i> </div>
